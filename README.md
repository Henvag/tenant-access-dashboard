...
What I *did* want in the repo: RLS isolation, Google + Entra, an audit trail (including failures and access/role changes), owner vs promoted admin, disable/re-enable, basic observability, EN/NO UI, **one portable image** on Render + Fly, a short ops write-up, and Terraform as an optional path next to the Blueprint.
