...
const en = {
  ...
  "agents.title": "Agents",
  "agents.hint":
    "People signed in here can use the company's ChatGPT, Claude, or Gemini key. Gemini has a free tier and can answer questions about this workspace. ChatGPT and Claude are billed to the company's key.",
  ...
  "agents.provider.google": "Gemini (Google)",
  "agents.geminiFree":
    "Gemini has a free tier. Get a key at aistudio.google.com. Free-tier requests are rate limited and Google may use them to improve its models, so keep sensitive material out until you add billing.",
  "agents.workspace": "Knows this workspace",
  "agents.workspaceHint":
    "Each message includes a briefing about this company: plan, apps, and for admins also people and recent activity. Everyone only gets what they could already see in the portal.",
  "agents.workspaceBadge": "Workspace",
  "agents.workspaceName": "Workspace",
  "agents.workspacePlaceholder": "Ask about people, apps, or this workspace",
  "agents.model": "Model",
  "agents.key": "API key",
  ...
  "agents.emptyBody":
    "Add Gemini with a free key from aistudio.google.com to answer questions about this workspace, or add a paid ChatGPT or Claude key.",
  ...
  "error.unknown_provider": "Choose ChatGPT, Claude, or Gemini.",
...
const no: Record<TKey, string> = {
  ...
  "agents.hint":
    "Folk som er logget inn her kan bruke selskapets ChatGPT-, Claude- eller Gemini-nøkkel. Gemini har et gratisnivå og kan svare på spørsmål om dette arbeidsområdet. ChatGPT og Claude belastes selskapets nøkkel.",
  ...
  "agents.provider.google": "Gemini (Google)",
  "agents.geminiFree":
    "Gemini har et gratisnivå. Hent en nøkkel på aistudio.google.com. Gratisforespørsler er begrenset i antall, og Google kan bruke dem til å forbedre modellene sine, så hold sensitivt innhold unna til dere legger til betaling.",
  "agents.workspace": "Kjenner dette arbeidsområdet",
  "agents.workspaceHint":
    "Hver melding får med en oppsummering av selskapet: plan, apper, og for administratorer også personer og nylig aktivitet. Alle får bare det de allerede kunne sett i portalen.",
  "agents.workspaceBadge": "Arbeidsområde",
  "agents.workspaceName": "Arbeidsområde",
  "agents.workspacePlaceholder": "Spør om personer, apper eller dette arbeidsområdet",
  "agents.model": "Modell",
  ...
  "agents.emptyBody":
    "Legg til Gemini med en gratis nøkkel fra aistudio.google.com for spørsmål om arbeidsområdet, eller en betalt ChatGPT- eller Claude-nøkkel.",
  ...
  "error.unknown_provider": "Velg ChatGPT, Claude eller Gemini.",
