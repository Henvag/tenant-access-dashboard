...
const en = {
  ...
  "landing.lede":
    "Register your company, let employees sign in with Google, and give admins a clear view of everyone in the tenant. Each company's data is isolated at the database level.",
  "feature.google.title": "Google sign-in",
  "feature.google.body": "OpenID Connect. No passwords to manage.",
  ...
  "signin.hint": "Use the Google account on your company's registered email domain.",
  "signin.google": "Continue with Google",
  "signin.new": "New company?",
  "signin.registerFirst": "Register it first",
  "register.title": "Register your company",
  "register.hint": "Takes ten seconds. Then sign in with Google to become admin.",
  "notice.registered": "{domain} is registered. Sign in with a @{domain} Google account.",

  "form.company": "Company name",
  "form.companyPlaceholder": "Acme Inc",
  "form.domain": "Email domain",
  "form.domainHelpBefore": "People sign in with Google using this domain. Use",
  "form.domainHelpAfter": "for a personal demo.",
...
const no: Record<TKey, string> = {
  ...
  "landing.lede":
    "Registrer selskapet, la ansatte logge inn med Google, og gi administratorer full oversikt over alle i tenanten. Hvert selskaps data er isolert på databasenivå.",
  "feature.google.title": "Google-innlogging",
  "feature.google.body": "OpenID Connect. Ingen passord å administrere.",
  ...
  "signin.hint": "Bruk Google-kontoen på selskapets registrerte e-postdomene.",
  ...
  "register.hint": "Tar ti sekunder. Logg deretter inn med Google for å bli administrator.",
  "notice.registered": "{domain} er registrert. Logg inn med en @{domain} Google-konto.",

  "form.company": "Selskapsnavn",
  "form.companyPlaceholder": "Acme AS",
  "form.domain": "E-postdomene",
  "form.domainHelpBefore": "Ansatte logger inn med Google via dette domenet. Bruk",
  "form.domainHelpAfter": "for en personlig demo.",
