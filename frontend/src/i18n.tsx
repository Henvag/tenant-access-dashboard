...
const en = {
  ...
  "people.disableConfirm":
    "Disable access for {email}? They cannot sign in again. Apps that registered a logout URL are told to end their session. Other apps, including the Grafana demo, stay open until that app's own session ends.",
  ...
  "ask.title": "Ask",
  "ask.hint":
    "Ask questions about {tenant}. Answers use a free Gemini key and only include what you can already see here.",
  ...
  "ask.enable": "Turn on Ask",
  "ask.saving": "Saving…",
  "ask.configured": "Gemini {model} · key ending {hint}",
  "ask.remove": "Remove key",
  "ask.starter": "Pick a question or type your own.",
  "ask.chipsLabel": "Suggested questions",
  "ask.chip.owner": "Who is the owner?",
  "ask.chip.apps": "Which apps can I open?",
  "ask.chip.upgrade": "What plan are we on, and can we upgrade?",
  "ask.chip.recent": "What happened recently in this workspace?",
  "ask.chip.whoami": "Who am I in this workspace?",
  "ask.chip.openApps": "How do I open an app?",
  "ask.placeholder": "Ask about people, apps, or this workspace",
  "ask.send": "Send",
  "ask.sending": "Sending…",
  "chat.thinking": "Thinking",
  "chat.reading": "Reading workspace",
  "chat.writing": "Writing",
  "org.title": "Organization",
  "org.hint": "Branding for this workspace. The logo shows in the sidebar and on invite links.",
  "org.logo": "Logo",
  "org.ownerOnly": "Only the owner can change the logo.",
  "org.requirements": "PNG, JPEG, WebP, or SVG. Under 200 KB.",
  "agents.title": "Agents",
  "agents.hint":
    "Company ChatGPT or Claude keys. Each message is billed to that key. For free workspace questions, use Ask.",
  "agents.add": "Add agent",
  "agents.name": "Name",
  "agents.provider": "Provider",
  "agents.provider.openai": "ChatGPT (OpenAI)",
  "agents.provider.anthropic": "Claude (Anthropic)",
  "agents.model": "Model",
  "agents.key": "API key",
  ...
  "agents.emptyBody":
    "Add a ChatGPT or Claude key if the company pays for those APIs. Free workspace questions live under Ask.",
  "agents.chatPlaceholder": "Message",
  "agents.send": "Send",
  "agents.sending": "Sending…",
  "agents.keyEnds": "Key ending {hint}",
  "apps.title": "Apps",
  ...
  "apps.logoutUrl": "Logout URL",
  "apps.logoutUrlHint":
    "Optional https address. When someone is disabled, we tell this app to end their session.",
  ...
  "error.logo_type": "Use a PNG, JPEG, WebP, or SVG image.",
  "error.logo_too_large": "Logo must be under 200 KB.",
  "error.agent_limit_reached": "You can add up to 20 agents.",
  "error.agent_not_found": "That agent is no longer available.",
  "error.https_url_required": "Agent links must start with https://",
  "error.unknown_provider": "Choose ChatGPT or Claude.",
  "error.model_not_allowed": "Choose one of the listed models.",
  "error.agent_key_required": "Paste the company's API key.",
  "error.agent_chat_failed": "The provider did not answer. Check the API key and try again.",
  "error.ask_not_configured": "Ask is not set up yet.",
  "error.ask_rate_limited":
    "Google's free quota for this key is used up for now. Wait a bit, or switch Ask to Gemini 3.5 Flash-Lite if you are on Flash.",
  "error.policy_not_supported": "Choose everyone or admins.",
...
const no: Record<TKey, string> = {
  ...
  "logo.change": "Last opp logo",
  "logo.clear": "Fjern logo",
  "logo.replace": "Bytt logo",
  ...
  "people.disableConfirm":
    "Deaktivere tilgang for {email}? De kan ikke logge inn igjen. Apper med en utloggingsadresse blir bedt om å avslutte økten. Andre apper, inkludert Grafana-demoen, forblir åpne til deres egen økt utløper.",
  ...
  "ask.title": "Spør",
  "ask.hint":
    "Still spørsmål om {tenant}. Svarene bruker en gratis Gemini-nøkkel og bare det du allerede kan se her.",
  ...
  "ask.enable": "Slå på Spør",
  "ask.saving": "Lagrer…",
  "ask.configured": "Gemini {model} · nøkkel som slutter på {hint}",
  "ask.remove": "Fjern nøkkel",
  "ask.starter": "Velg et spørsmål eller skriv ditt eget.",
  "ask.chipsLabel": "Foreslåtte spørsmål",
  "ask.chip.owner": "Hvem er eieren?",
  "ask.chip.apps": "Hvilke apper kan jeg åpne?",
  "ask.chip.upgrade": "Hvilken plan har vi, og kan vi oppgradere?",
  "ask.chip.recent": "Hva har skjedd nylig i dette arbeidsområdet?",
  "ask.chip.whoami": "Hvem er jeg i dette arbeidsområdet?",
  "ask.chip.openApps": "Hvordan åpner jeg en app?",
  "ask.placeholder": "Spør om personer, apper eller dette arbeidsområdet",
  "ask.send": "Send",
  "ask.sending": "Sender…",
  "chat.thinking": "Tenker",
  "chat.reading": "Leser arbeidsområdet",
  "chat.writing": "Skriver",
  "org.title": "Organisasjon",
  "org.hint": "Profil for dette arbeidsområdet. Logoen vises i sidemenyen og på invitasjonslenker.",
  "org.logo": "Logo",
  "org.ownerOnly": "Bare eieren kan endre logoen.",
  "org.requirements": "PNG, JPEG, WebP eller SVG. Under 200 KB.",
  "agents.title": "Agenter",
  "agents.hint":
    "Selskapets ChatGPT- eller Claude-nøkler. Hver melding belastes den nøkkelen. For gratis spørsmål om arbeidsområdet, bruk Spør.",
  "agents.add": "Legg til agent",
  "agents.name": "Navn",
  "agents.provider": "Leverandør",
  "agents.provider.openai": "ChatGPT (OpenAI)",
  "agents.provider.anthropic": "Claude (Anthropic)",
  "agents.model": "Modell",
  "agents.key": "API-nøkkel",
  ...
  "agents.emptyBody":
    "Legg til en ChatGPT- eller Claude-nøkkel hvis selskapet betaler for de API-ene. Gratis spørsmål om arbeidsområdet ligger under Spør.",
  "agents.chatPlaceholder": "Melding",
  "agents.send": "Send",
  "agents.sending": "Sender…",
  "agents.keyEnds": "Nøkkel som slutter på {hint}",
  "apps.title": "Apper",
  ...
  "apps.logoutUrl": "Utloggingsadresse",
  "apps.logoutUrlHint":
    "Valgfri https-adresse. Når noen deaktiveres, ber vi appen avslutte økten deres.",
  ...
  "error.logo_type": "Bruk et PNG-, JPEG-, WebP- eller SVG-bilde.",
  "error.logo_too_large": "Logoen må være under 200 KB.",
  "error.agent_limit_reached": "Du kan legge til opptil 20 agenter.",
  "error.agent_not_found": "Den agenten er ikke lenger tilgjengelig.",
  "error.https_url_required": "Agentlenker må starte med https://",
  "error.unknown_provider": "Velg ChatGPT eller Claude.",
  "error.model_not_allowed": "Velg en av modellene i listen.",
  "error.agent_key_required": "Lim inn selskapets API-nøkkel.",
  "error.agent_chat_failed": "Leverandøren svarte ikke. Sjekk API-nøkkelen og prøv igjen.",
  "error.ask_not_configured": "Spør er ikke satt opp ennå.",
  "error.ask_rate_limited":
    "Googles gratis kvote for denne nøkkelen er brukt opp for nå. Vent litt, eller bytt Spør til Gemini 3.5 Flash-Lite hvis du bruker Flash.",
  "error.policy_not_supported": "Velg alle eller administratorer.",
