...
const en = {
  ...
  "ask.starter": "Try: who is the owner, which apps can I open, or what plan are we on?",
...
const no: Record<TKey, string> = {
  ...
  "ask.starter": "Prøv: hvem er eieren, hvilke apper kan jeg åpne, eller hvilken plan har vi?",
