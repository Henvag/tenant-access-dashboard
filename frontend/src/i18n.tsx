...
const en = {
  ...
  "agents.title": "Agents",
  "agents.hint":
    "People signed in here can use the company's ChatGPT or Claude account. Each message is billed to the company's API key.",
  ...
  "agents.emptyBody":
    "Add ChatGPT or Claude with the company's API key. People open it from this tab after they sign in.",
...
const no: Record<TKey, string> = {
  ...
  "agents.hint":
    "Folk som er logget inn her kan bruke selskapets ChatGPT- eller Claude-konto. Hver melding belastes selskapets API-nøkkel.",
  ...
  "agents.emptyBody":
    "Legg til ChatGPT eller Claude med selskapets API-nøkkel. Folk åpner den fra denne fanen etter at de har logget inn.",
